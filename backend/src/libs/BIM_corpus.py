...
def handle_process(path='src/data/Corpus_Convert', save_path='', save=False):
    ...
    if save:
        write_file(os.path.join(save_path, 'Bim_Corpus_docToken.txt'), docToken)
        write_file(os.path.join(save_path, 'Bim_Corpus_dataset.txt'), dataset)